  ...
  const renderContent = () => {
    switch (currentView) {
      ...
      default:
        return (
          <>
            <Title>Start Your Readiness Quiz</Title>
            
            <Description>
              Create a free account to take our readiness quiz and get your personalized score to assess your company's preparedness for offshore team expansion.
            </Description>
